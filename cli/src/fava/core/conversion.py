...
from .inventory import SimpleCounterInventory, _Amount
...
if TYPE_CHECKING:  # pragma: no cover
    ...
    from ..beans.protocols import Amount, Position
...
def get_cost(pos: Position) -> Amount:
    ...
    cost_ = pos.cost
    return _Amount(cost_.number * pos.units.number, cost_.currency) if cost_ is not None else pos.units
